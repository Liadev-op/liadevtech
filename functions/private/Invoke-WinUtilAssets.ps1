function Invoke-WinUtilAssets {
  ...
  switch ($type) {
      'logo' {
          # Liadev Tech logo: blue rounded square, white "L", light-blue accent dot
          $brush = [System.Windows.Media.BrushConverter]::new()

          $logoSquare = New-Object Windows.Shapes.Rectangle
          $logoSquare.Width = 92
          $logoSquare.Height = 92
          $logoSquare.RadiusX = 24
          $logoSquare.RadiusY = 24
          $logoSquare.Fill = $brush.ConvertFromString("#1E5EDB")
          $logoSquare.SetValue([Windows.Controls.Canvas]::LeftProperty, [double]4)
          $logoSquare.SetValue([Windows.Controls.Canvas]::TopProperty, [double]4)

          $logoLVertical = New-Object Windows.Shapes.Rectangle
          $logoLVertical.Width = 15
          $logoLVertical.Height = 48
          $logoLVertical.RadiusX = 5
          $logoLVertical.RadiusY = 5
          $logoLVertical.Fill = [Windows.Media.Brushes]::White
          $logoLVertical.SetValue([Windows.Controls.Canvas]::LeftProperty, [double]30)
          $logoLVertical.SetValue([Windows.Controls.Canvas]::TopProperty, [double]26)

          $logoLHorizontal = New-Object Windows.Shapes.Rectangle
          $logoLHorizontal.Width = 42
          $logoLHorizontal.Height = 15
          $logoLHorizontal.RadiusX = 5
          $logoLHorizontal.RadiusY = 5
          $logoLHorizontal.Fill = [Windows.Media.Brushes]::White
          $logoLHorizontal.SetValue([Windows.Controls.Canvas]::LeftProperty, [double]30)
          $logoLHorizontal.SetValue([Windows.Controls.Canvas]::TopProperty, [double]59)

          $logoDot = New-Object Windows.Shapes.Ellipse
          $logoDot.Width = 17
          $logoDot.Height = 17
          $logoDot.Fill = $brush.ConvertFromString("#7FB8FF")
          $logoDot.SetValue([Windows.Controls.Canvas]::LeftProperty, [double]58)
          $logoDot.SetValue([Windows.Controls.Canvas]::TopProperty, [double]27)

          $canvas.Children.Add($logoSquare) | Out-Null
          $canvas.Children.Add($logoLVertical) | Out-Null
          $canvas.Children.Add($logoLHorizontal) | Out-Null
